...
//
//        //when
//        Iterable<User> foundAllOK = userServiceImpl.findAll();
//
//        //then
...
//
//        //when
//        Iterable<User> foundAllERR = userServiceImpl.findAll();
//
//        //then
...
//
//        //when
//        Optional<User> foundUserByIdOK = userServiceImpl.findById(1L);
//
//        //then
...
//
//        //when
//        User foundAllDtoOK = userServiceImpl.findUserByEmail("Kittoki@gmail.com");
//
//        //then
...
//
//        //when
//        User foundAllDtoOK = userServiceImpl.findUserByPhone("789355718");
//
//        //then
//        assertEquals(foundAllDtoOK.getUserId(), user.getUserId());
//        assertEquals(foundAllDtoOK.getName(), user.getName());
...
//
//        //when
//        List<User> foundAllOK = userServiceImpl.findUserByRole("CUSTOMER");
//
//        //then
//        assertEquals(foundAllOK, userListOK);
//    }
...
//
//        //when
//        List<User> foundAllERR = userServiceImpl.findUserByRole("CUSTOMER");
//
//        //then
//        assertEquals(foundAllERR, Collections.EMPTY_LIST);
//    }
